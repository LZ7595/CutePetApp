...
const homeIndex = () => {
  ...
  const typeSels = [{ img: '/src/assets/寄养.png', word: '我要寄养', width: '40px', height: '36px' , url:'/foster' }, { img: '/src/assets/美容.png', word: '宠物美容', width: '33px', height: '35px', url:'/beauty' }, { img: '/src/assets/医疗.png', word: '宠物医疗', width: '37px', height: '34px', url:'/medical' }, { img: '/src/assets/百科.png', word: '知识百科', width: '30px', height: '36px', url:'/wiki' }]
